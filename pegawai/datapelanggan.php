        ...
        <table class="table">
		  ...
		  ?>
			  <tr>
				  ...
				  <td>
				  <a href="#" class="btn btn-warning" data-toggle="modal" data-target="#edit-pelanggan<?= $pelanggan['id']; ?>"><i class='bx bxs-edit'></i></a>
...
<a href="hapuspelanggan.php?id=<?= htmlspecialchars($pelanggan['id']); ?>" class="btn btn-danger" role="button" title="hapus"><i class='bx bxs-trash'></i></a>
